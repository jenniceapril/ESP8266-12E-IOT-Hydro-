...
const char *ap_ssid = "REDLAB-AccessPoint";

const char *ap_password = "redlab";
...

{
  ...
  String response_message = "<html><head><title>REDLAB Webserver</title></head>";

  response_message += "<body style=\"background-color:PaleGoldenRod\"><h1><center>REDLAB Webserver</center></h1>";
...

{
  ...
  response_message += "<head><title>REDLAB Webserver</title></head>";
